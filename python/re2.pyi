...
class _Regexp(Generic[_PatternType]):
  ...
  # def _split(
  #   self,
  #   cb: Callable[[_Match[_PatternType]], _PatternType],
  #   text: _PatternType,
  #   maxsplit: int = 0,
  # ) -> tuple[list[_PatternType], int]:
  #   ...
...
class _Match(Generic[_PatternType]):
  ...
  # _OCTAL_RE: ClassVar[_Regexp[str]]
  # _GROUP_RE: ClassVar[_Regexp[str]]

  # @classmethod
  # def _split(cls, template: _PatternType) -> list[_PatternType]:
  #   ...
